...
WebUI.click(findTestObject('Object Repository/profile/add user child/detail user child/detail_button_ubah_password'))

WebUI.setText(findTestObject('Object Repository/profile/add user child/detail user child/detail_password'),new_password)

WebUI.setText(findTestObject('Object Repository/profile/add user child/detail user child/detail_konfirmasi_password'),konfirmasi_password)

WebUI.click(findTestObject('Object Repository/profile/add user child/detail user child/detail_button_terapkan_dan_masuk'))
