...
WebUI.verifyElementPresent(findTestObject('Object Repository/Login/Page_Login  Rajawali Putra Logistik/p_Email Wajib diisi'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Login/Page_Login  Rajawali Putra Logistik/span_password Wajib diisi minimal 6 Karakter'), 
    0)
