...
WebUI.uploadFile(findTestObject('Object Repository/profile/add user child/detail user child/detail_upload_photo'), foto)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/profile/add user child/detail user child/detail_verify_avatar'), 0)
