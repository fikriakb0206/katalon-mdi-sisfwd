...
WebUI.verifyElementHasAttribute(findTestObject('Object Repository/profile/add user child/detail user child/detail_nama'), 'readonly', 0)

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/profile/add user child/detail user child/detail_email'), 'readonly', 0)

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/profile/add user child/detail user child/detail_telepon'), 'readonly', 0)

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/profile/add user child/detail user child/detail_role'), 'readonly', 0)

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/profile/add user child/detail user child/detail_division'), 'readonly', 0)
