...
WebUI.setText(findTestObject('Login/Page_Login  Rajawali Putra Logistik/username'), 'wrong@email.com')

WebUI.setEncryptedText(findTestObject('Login/Page_Login  Rajawali Putra Logistik/password'), 
    'aeHFOx8jV/A=')

WebUI.click(findTestObject('Login/Page_Login  Rajawali Putra Logistik/button_Masuk'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Login/Page_Login  Rajawali Putra Logistik/h2_User Tidak Terdaftar'), 
    0)
